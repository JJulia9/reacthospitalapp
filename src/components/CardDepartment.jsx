      ...
      {/* {departments && ( */}
        ...
        >
          ...
          <div className="py-2 px-9 relative">
            ...
            <div>
              {/* <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white">{departments.name}</h3>
              <p className="mt-4 text-base text-gray-600 group-hover:text-white">{departments.details}</p> */}
            </div>
          </div>
        </a>
      {/* )} */}
